...
const { getAllUsers, getUser, getUserContents, deleteUser, checkUsername, getCurrentUser, updateUser } = require('../controllers/users.controller')
...
router.route('/:id/contents').get([auth, authorizePermissions('admin')],getUserContents)
